# 🎨 Presentación Creadores — CALMÉCAC

Propuesta Comercial para Influencers y Creadores de Contenido — Campaña e Incubadora E-commerce desarrollada por **CALMÉCAC**.
...
En la carpeta `creadores`, puedes ejecutar los siguientes comandos:
...
## 🎨 Tema
Utiliza el tema oficial de la organización: [`@calmecac/slidev-theme-calmecac`](https://github.com/Calmecac-MX/theme-slidev).
